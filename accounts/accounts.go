...
// Package accounts implements high level Ethcc account management.
package accounts
...
// Account represents an Ethcc account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Ethcc account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain ethcc.ChainStateReader)
