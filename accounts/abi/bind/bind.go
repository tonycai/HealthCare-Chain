...
// Package bind generates Ethcc contract Go bindings.
//
// Detailed usage document and tutorial available on the healthcare-chain Wiki page:
// https://github.com/tonycai/HealthCare-Chain/wiki/Native-DApps:-Go-bindings-to-Ethcc-contracts
package bind
