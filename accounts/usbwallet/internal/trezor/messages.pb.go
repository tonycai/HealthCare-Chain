...
const (
	...
	MessageType_MessageType_EthccGetAddress       MessageType = 56
	MessageType_MessageType_EthccAddress          MessageType = 57
	MessageType_MessageType_EthccSignTx           MessageType = 58
	MessageType_MessageType_EthccTxRequest        MessageType = 59
	MessageType_MessageType_EthccTxAck            MessageType = 60
	...
	MessageType_MessageType_EthccSignMessage      MessageType = 64
	MessageType_MessageType_EthccVerifyMessage    MessageType = 65
	MessageType_MessageType_EthccMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_EthccGetAddress",
	57:  "MessageType_EthccAddress",
	58:  "MessageType_EthccSignTx",
	59:  "MessageType_EthccTxRequest",
	60:  "MessageType_EthccTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_EthccSignMessage",
	65:  "MessageType_EthccVerifyMessage",
	66:  "MessageType_EthccMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_EthccGetAddress":       56,
	"MessageType_EthccAddress":          57,
	"MessageType_EthccSignTx":           58,
	"MessageType_EthccTxRequest":        59,
	"MessageType_EthccTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_EthccSignMessage":      64,
	"MessageType_EthccVerifyMessage":    65,
	"MessageType_EthccMessageSignature": 66,
...
// *
// Request: Ask device for Ethcc address corresponding to address_n path
// @next PassphraseRequest
// @next EthccAddress
// @next Failure
type EthccGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *EthccGetAddress) Reset()                    { *m = EthccGetAddress{} }
func (m *EthccGetAddress) String() string            { return proto.CompactTextString(m) }
func (*EthccGetAddress) ProtoMessage()               {}
func (*EthccGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *EthccGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *EthccGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Ethcc address derived from device private seed
// @prev EthccGetAddress
type EthccAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *EthccAddress) Reset()                    { *m = EthccAddress{} }
func (m *EthccAddress) String() string            { return proto.CompactTextString(m) }
func (*EthccAddress) ProtoMessage()               {}
func (*EthccAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *EthccAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *EthccSignTx) Reset()                    { *m = EthccSignTx{} }
func (m *EthccSignTx) String() string            { return proto.CompactTextString(m) }
func (*EthccSignTx) ProtoMessage()               {}
func (*EthccSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *EthccSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *EthccSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *EthccSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *EthccSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *EthccSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *EthccSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *EthccSignTx) GetDataLength() uint32 {
...
func (m *EthccSignTx) GetChainId() uint32 {
...
func (m *EthccTxRequest) Reset()                    { *m = EthccTxRequest{} }
func (m *EthccTxRequest) String() string            { return proto.CompactTextString(m) }
func (*EthccTxRequest) ProtoMessage()               {}
func (*EthccTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *EthccTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *EthccTxRequest) GetSignatureV() uint32 {
...
func (m *EthccTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *EthccTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev EthccTxRequest
// @next EthccTxRequest
type EthccTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *EthccTxAck) Reset()                    { *m = EthccTxAck{} }
func (m *EthccTxAck) String() string            { return proto.CompactTextString(m) }
func (*EthccTxAck) ProtoMessage()               {}
func (*EthccTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *EthccTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next EthccMessageSignature
// @next Failure
type EthccSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *EthccSignMessage) Reset()                    { *m = EthccSignMessage{} }
func (m *EthccSignMessage) String() string            { return proto.CompactTextString(m) }
func (*EthccSignMessage) ProtoMessage()               {}
func (*EthccSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *EthccSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *EthccSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type EthccVerifyMessage struct {
...
func (m *EthccVerifyMessage) Reset()                    { *m = EthccVerifyMessage{} }
func (m *EthccVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*EthccVerifyMessage) ProtoMessage()               {}
func (*EthccVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *EthccVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *EthccVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *EthccVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev EthccSignMessage
type EthccMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *EthccMessageSignature) Reset()                    { *m = EthccMessageSignature{} }
func (m *EthccMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*EthccMessageSignature) ProtoMessage()               {}
func (*EthccMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *EthccMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *EthccMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*EthccGetAddress)(nil), "EthccGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*EthccAddress)(nil), "EthccAddress")
	...
	proto.RegisterType((*EthccSignTx)(nil), "EthccSignTx")
	proto.RegisterType((*EthccTxRequest)(nil), "EthccTxRequest")
	proto.RegisterType((*EthccTxAck)(nil), "EthccTxAck")
	proto.RegisterType((*EthccSignMessage)(nil), "EthccSignMessage")
	proto.RegisterType((*EthccVerifyMessage)(nil), "EthccVerifyMessage")
	proto.RegisterType((*EthccMessageSignature)(nil), "EthccMessageSignature")
