...
import (
	...
	"github.com/tonycai/HealthCare-Chain/cmd/utils"
	"github.com/tonycai/HealthCare-Chain/common"
	"github.com/tonycai/HealthCare-Chain/console"
	"github.com/tonycai/HealthCare-Chain/crypto"
	"github.com/tonycai/HealthCare-Chain/ethclient"
	"github.com/tonycai/HealthCare-Chain/internal/debug"
	...
	"github.com/tonycai/HealthCare-Chain/swarm"
	bzzapi "github.com/tonycai/HealthCare-Chain/swarm/api"
	swarmmetrics "github.com/tonycai/HealthCare-Chain/swarm/metrics"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:   "swap-api",
		Usage:  "URL of the Ethcc API provider to use to settle SWAP payments",
...
var app = utils.NewApp(gitCommit, "Ethcc Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The healthcare-chain Authors"
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.ethcc/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.ethcc/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:    dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.ethcc/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.ethcc/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:    dbClean,
...
func bzzd(ctx *cli.Context) error {
	...
	//register BZZ as node.Service in the ethcc node
...
func registerBzzService(bzzconfig *bzzapi.Config, ctx *cli.Context, stack *node.Node) {
	...
	//register within the ethcc node
