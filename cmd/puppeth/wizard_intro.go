...
// setting up a new or managing an existing Ethcc private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Ethcc private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Ethcc network down to  |")
	...
	log.Info("Administering Ethcc network", "name", w.network)
