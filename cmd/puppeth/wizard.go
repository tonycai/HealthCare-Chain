...
type wizard struct {
	...
	services map[string][]string   // Ethcc services known to be running on servers
...
// converts it to an Ethcc address. If an empty line is entered, the default
// value is returned.
