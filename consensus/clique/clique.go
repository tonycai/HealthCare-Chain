...
import (
	...
	"github.com/tonycai/HealthCare-Chain/crypto/sha3"
...
// ecrecover extracts the Ethcc account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Ethcc address
...
// Ethcc testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Ethcc address of the signing key
...
// Author implements consensus.Engine, returning the Ethcc address recovered
