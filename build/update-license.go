...
var (
	...
	authorsFileHeader = "# This is the official list of healthcare-chain authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The healthcare-chain Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "healthcare-chain"
	}
	if startOfSentence {
		return "The healthcare-chain library"
	}
	return "the healthcare-chain library"
}
