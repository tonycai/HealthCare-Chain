...
!define HELPURL "https://github.com/tonycai/HealthCare-Chain/issues"
!define UPDATEURL "https://github.com/tonycai/HealthCare-Chain/releases"
!define ABOUTURL "https://github.com/tonycai/HealthCare-Chain#ethcc-go"
...
Section "Geth" GETH_IDX
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethcc" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethcc" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethcc" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/tonycai/HealthCare-Chain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHCC_SOCKET" "R" "HKLM" "\\.\pipe\geth.ipc"
  ${EnvVarUpdate} $0 "ETHCC_SOCKET" "A" "HKLM" "\\.\pipe\geth.ipc"
