...
We want to build healthcare-chain with the most recent version of Go, irrespective of the Go
...
can be edited at https://launchpad.net/%7Eethcc/+archive/ubuntu/ethcc/+edit-dependencies
...
Then go into the source package directory for your running distribution and build the package:
    ...
    $ cd dist/ethcc-unstable-1.6.0+xenial
    $ dpkg-buildpackage
