...
// Service implements an Ethcc netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Ethcc      // Full Ethcc service if monitoring a full node
	les    *les.LightEthcc // Light Ethcc service if monitoring a light node
...
func New(url string, ethServ *eth.Ethcc, lesServ *les.LightEthcc) (*Service, error) {
