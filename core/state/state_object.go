...
// stateObject represents an Ethcc account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of ethcc address of the account
	data     Account
	db       *StateDB
...
// Account is the Ethcc consensus representation of accounts.
