...
// Package types contains data types related to Ethcc consensus.
package types
...
// Header represents a block header in the Ethcc blockchain.
type Header struct {
...
// Block represents an entire block in the Ethcc blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Ethcc RLP block format.
