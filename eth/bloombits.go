...
import (
	...
	"github.com/tonycai/HealthCare-Chain/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Ethcc
...
func (eth *Ethcc) startBloomHandlers() {
...
// for the Ethcc header bloom filters, permitting blazing fast filtering.
